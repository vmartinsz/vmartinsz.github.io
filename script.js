const translations = {
  pt: {
    ...
    wifiTitle: 'Conecte-se à rede Meli-Guest', wifiIntro: 'É muito importante estar conectado ao WiFi Meli-Guest. O aplicativo MyAhgora só irá funcionar conectado nessa rede.', wifiStepsTitle: 'Passo a passo', wifiStep1: 'Selecione a rede WiFi Meli-Guest.', wifiStep2: 'A página de registro será aberta.', wifiStep3: 'Preencha nome, e-mail e aceite os termos.', wifiStep4: 'No campo Palavra Chave (Passphrase), digite: <strong>Meli@Guest</strong>.', wifiStep5: 'Finalize o registro e aguarde a conexão.', wifiDnsTitle: 'Erro de DNS?', wifiDnsText: 'Alguns celulares ficam com DNS manual configurado. Coloque o DNS em automático. Se tiver dúvidas ou problemas de conexão, peça para seu TL ou PS abrir um chamado para o time de IS.', imagePlaceholder: 'Substitua esta imagem pelo print explicativo.',
    ...
    wifiCap1: '<strong>1/5</strong> Selecione a rede Meli-Guest', wifiCap2: '<strong>2/5</strong> Aguarde abrir a página de registro', wifiCap3: '<strong>3/5</strong> Preencha nome, e-mail e aceite os termos', wifiCap4: '<strong>4/5</strong> Digite a Palavra Chave (Passphrase): Meli@Guest', wifiCap5: '<strong>5/5</strong> Finalize e aguarde conectar',
    ...
    chatCap1: '<strong>1/6</strong> Baixe o Google Chat', chatCap2: '<strong>2/6</strong> Toque na foto/letra no canto superior direito', chatCap3: '<strong>3/6</strong> Clique em adicionar outra conta', chatCap4: '<strong>4/6</strong> Informe seu e-mail Mercado Livre', chatCap5: '<strong>5/6</strong> Digite a senha e valide o acesso', chatCap6: '<strong>6/6</strong> Abra o People Chat e escreva “Falar com um atendente” quando precisar',
...
translations.es = {
  ...
  wifiTitle: 'Conéctate a la red Meli-Guest', wifiIntro: 'Es muy importante estar conectado al WiFi Meli-Guest. La app MyAhgora solo funcionará conectada a esta red.', wifiStepsTitle: 'Paso a paso', wifiStep1: 'Selecciona la red WiFi Meli-Guest.', wifiStep2: 'Se abrirá la página de registro.', wifiStep3: 'Completa nombre, e-mail y acepta los términos.', wifiStep4: 'En el campo Palavra Chave (Passphrase), escribe: <strong>Meli@Guest</strong>.', wifiStep5: 'Finaliza el registro y espera la conexión.', wifiDnsTitle: '¿Error de DNS?', wifiDnsText: 'Algunos celulares tienen DNS manual configurado. Coloca el DNS en automático. Si tienes dudas o problemas de conexión, pide a tu TL o PS que abra un ticket para IS.', imagePlaceholder: 'Reemplaza esta imagen por el print explicativo.',
  ...
  wifiCap1: '<strong>1/5</strong> Selecciona la red Meli-Guest', wifiCap2: '<strong>2/5</strong> Espera a que se abra la página de registro', wifiCap3: '<strong>3/5</strong> Completa nombre, e-mail y acepta los términos', wifiCap4: '<strong>4/5</strong> Escribe la Palavra Chave (Passphrase): Meli@Guest', wifiCap5: '<strong>5/5</strong> Finaliza y espera la conexión',
  ...
  chatCap1: '<strong>1/6</strong> Descarga Google Chat', chatCap2: '<strong>2/6</strong> Toca la foto/letra en la esquina superior derecha', chatCap3: '<strong>3/6</strong> Toca agregar otra cuenta', chatCap4: '<strong>4/6</strong> Ingresa tu e-mail de Mercado Libre', chatCap5: '<strong>5/6</strong> Ingresa la contraseña y valida el acceso', chatCap6: '<strong>6/6</strong> Abre People Chat y escribe “Falar com um atendente” cuando lo necesites',
...
translations.en = {
  ...
  wifiTitle: 'Connect to Meli-Guest WiFi', wifiIntro: 'It is very important to be connected to Meli-Guest WiFi. The MyAhgora app will only work on this network.', wifiStepsTitle: 'Step by step', wifiStep1: 'Select the Meli-Guest WiFi network.', wifiStep2: 'The registration page will open.', wifiStep3: 'Fill in your name, e-mail and accept the terms.', wifiStep4: 'In the Palavra Chave (Passphrase) field, type: <strong>Meli@Guest</strong>.', wifiStep5: 'Finish registration and wait for the connection.', wifiDnsTitle: 'DNS error?', wifiDnsText: 'Some phones have manual DNS configured. Set DNS to automatic. If you have questions or connection issues, ask your TL or PS to open a ticket for IS.', imagePlaceholder: 'Replace this image with the explanatory screenshot.',
  ...
  wifiCap1: '<strong>1/5</strong> Select the Meli-Guest network', wifiCap2: '<strong>2/5</strong> Wait for the registration page to open', wifiCap3: '<strong>3/5</strong> Fill in name, e-mail and accept the terms', wifiCap4: '<strong>4/5</strong> Type the Palavra Chave (Passphrase): Meli@Guest', wifiCap5: '<strong>5/5</strong> Finish and wait for connection',
  ...
  chatCap1: '<strong>1/6</strong> Download Google Chat', chatCap2: '<strong>2/6</strong> Tap the photo/letter in the upper-right corner', chatCap3: '<strong>3/6</strong> Tap add another account', chatCap4: '<strong>4/6</strong> Enter your Mercado Libre e-mail', chatCap5: '<strong>5/6</strong> Enter the password and validate access', chatCap6: '<strong>6/6</strong> Open People Chat and type “Falar com um atendente” when needed',
